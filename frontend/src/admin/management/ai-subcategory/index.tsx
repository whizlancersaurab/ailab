...
import { addAiSubCategory, aiCategoryForOption, allAiSubCategories, deleteAiSubCategory, getAiSpeSubCategory, updateAiSubCategory} from "../../../service/api";
...
const SubCategory = () => {
    ...
    const fetchSubCategories = async () => {
        ...
        try {
            const { data } = await allAiSubCategories()
            if (data.success) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const { data } = await addAiSubCategory(payload);
    ...
    const fetchSpecificCategory = async (id: number) => {
        ...
        try {
            const { data } = await getAiSpeSubCategory(id)
            console.log(data)
    ...
    const handleUpdate = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const { data } = await updateAiSubCategory({ sub_category_name: editData }, editId)
            if (data.success) {
                toast.success(data.message)
                setEditId(null)
                setEditData("")
    ...
    const handleDelete = async (id: number, e: React.MouseEvent<HTMLButtonElement>) => {
        ...
        console.log(id)
        try {
            const { data } = await deleteAiSubCategory(id)
            if (data.success) {
                setDeleteId(null)
                toast.success(data.message)
                fetchSubCategories()
