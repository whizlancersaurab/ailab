...
import { AiOutOfStockDevicesForSchoolDas} from "../../../../service/api";
...
const AiOutOfStockDeviceForSchoolDas = () => {
    ...
    const fetchdevices = async (schoolId: number) => {
        setLoading(true);
        try {
            const { data } = await AiOutOfStockDevicesForSchoolDas(schoolId);
...
export default AiOutOfStockDeviceForSchoolDas;
