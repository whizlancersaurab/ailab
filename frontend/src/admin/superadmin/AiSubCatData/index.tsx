...
import { allAISubCategoriesForSchoolDas } from "../../../service/api";
...
const AiSubCategoryForSchoolDas = () => {
    ...
    const fetchSubCategories = async (schoolId: number) => {
        setLoading(true)
        try {
            const { data } = await allAISubCategoriesForSchoolDas(schoolId)
            if (data.success) {
                ...
                <div className="content">
                    ...
                    <div className="d-md-flex d-block align-items-center justify-content-between mb-3">
                        <div className="my-auto mb-2">
                            <h3 className="page-title mb-1">AI Sub-Category List</h3>
                            <nav>
...
export default AiSubCategoryForSchoolDas;