...
import { roboDeviceTypeCountWithDataForSchoolDas } from "../../../../service/api.ts";
import { Spinner } from "../../../../spinner.tsx";

const RoboticsDeviceTypeList = () => {
    ...
    const fetchDeviceTypesList = async (schoolId: number) => {
        ...
        try {
            const { data } = await roboDeviceTypeCountWithDataForSchoolDas(schoolId)
            if (data.success) {
...
export default RoboticsDeviceTypeList;