...
import { roboAllDevicesForSchoolDas } from "../../../../service/api.ts";
// allClasses
...
const RoboticsDevice = () => {
    ...
    const fetchdevices = async (schoolId: number) => {
        ...
        try {
            const { data } = await roboAllDevicesForSchoolDas(schoolId)
