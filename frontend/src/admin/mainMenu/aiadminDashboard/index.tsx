...
import DeviceModal from "../../management/ai-devices/device-list/DeviceModl";
import { AideviceCount, AideviceTypeCount, AigetOutOfStockCount, classForOption, classProgressData} from "../../../service/api";
          ...
          <>
            <div className="d-md-flex d-block align-items-center justify-content-between mb-3">
              <div className="my-auto mb-2">
                <h3 className="page-title mb-1">AI Lab</h3>
                <nav>
            ...
            <div className="row">
              ...
              <div className="col-xxl-4 col-sm-6 d-flex">
                <div className="card flex-fill animate-card border-0">
                  <div className="card-body">
                    <Link to={routes.aidevicetypelist}>
                      <div className="d-flex align-items-center">
