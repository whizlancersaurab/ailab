...
exports.addCategory = async (req, res) => {
  ...
  try {
    ...
    const [existing] = await db.query(
      `SELECT id FROM ai_category WHERE LOWER(category) = LOWER(?) AND school_id=?`,
    ...
    const sql = `INSERT INTO ai_category (category , school_id) VALUES (? ,?)`
...
exports.updateCategory = async (req, res) => {
  ...
  try {
    ...
    const [duplicate] = await db.query(
      `SELECT id FROM ai_category WHERE LOWER(category) = LOWER(?) AND school_id=? AND id != ?`,
...
exports.deleteCategory = async (req, res) => {
  ...
  try {
    ...
    const sql = `DELETE FROM ai_category WHERE id = ? AND school_id=?`
...
exports.categoryForOption = async (req, res) => {
    const schoolId =  req.schoolId
  try {
    const sql = `SELECT id, category FROM ai_category WHERE school_id=?`
    const [rows] = await db.query(sql , [schoolId])
